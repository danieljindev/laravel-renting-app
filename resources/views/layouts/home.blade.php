...
<footer id="footer-main">
    <div class="container">
        <div class="col-md-3">
            <h6>{!! trans('home.ABOUT') !!} <span>Pilgrimway</span></h6>
            <div class="text">
        ...
        <div class="col-md-3">
            ...
            <div class="text">
                <p><span>Pilgrimway {!! trans('home.office') !!} 1:</span> (123) 456-6789</p>
                <p><span>Pilgrimway {!! trans('home.office') !!} 2:</span> (222) 222-2222</p>
                <p><span>Email:</span> <a href="mailto:contact@pilgrimway.com">contact@pilgrimway.com</a></p>
            </div>
        </div>
        <div class="col-md-3">
